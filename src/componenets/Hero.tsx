        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-400 leading-relaxed max-w-lg">
              Accustomed to working under pressure and with limited resources, I
              don't kneel before any challenge. I've been slowly but surely
              improving at Ae and Pr alike. Deadlines don't intimidate me.
            </p>
          </div>

          <div className="flex space-x-6">
            <a
              href="https://www.discord.com/users/461310381701201951"
              target="blank"
            ...
            <a
              href="https://x.com/Cikatris_Editor"
              target="_blank"
              rel="noreferrer"
